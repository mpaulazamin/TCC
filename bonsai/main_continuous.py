...
#class ChuveiroTurbinadoSimulation():
    ...
    def reset(
        ...
        self.iqb = malha_fechada.compute_iqb(self.T4a, self.Fs) or 0
    ...
    #def episode_start(self, config) -> None:
        ...
        self.reset(
            ...
            SPT4a_0 = config.get('initial_setpoint_final_temperature') or 37,
        )
...
def main_test():
    ...
    TU=[[ 10,       38,   50,   0.3,     60,   0.4672,   0,  25,   25],
        ...
        [ 30,       38,   50,   0.3,     70,   0.9,   0,  25,   25],
        [ 40,       38,   50,   0.3,     70,   0.9,   1,  25,   25],
        [ 50,       38,   50,   0.3,     70,   0.9,   1,  25,   25],
        [ 60,       38,   50,   0.1,     70,   0.9,   1,  28,   25],
        [ 70,       38,   50,   0.1,     70,   0.9,   1,  28,   25],
        [ 80,       38,   50,   0.1,     70,   0.9,   1,  28,   25],
        [ 90,       38,   50,   0.1,     70,   0.9,   1,  28,   20],
        [100,       38,   50,   0.1,     70,   0.9,   1,  28,   20]]   
