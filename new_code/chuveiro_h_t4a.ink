...
type SimConfig {
    ...
    initial_setpoint_final_temperature: number
}
...
type SimState {
    ...
    tank_level: number,
    setpoint_final_temperature: number,
    ...
    cost_water: number,
    difference_setpoint_t4a: number
}

type Action {
    hot_valve_opening: number <0.3 .. 0.5>,
    out_valve_opening: number <0.3 .. 0.5>,
    setpoint_final_temperature: number <34 .. 44>,
    ...
    concept Concept(input): Action {
        curriculum {
            ...
            goal (state: SimState) {
                ...
                # MinimizeDT:
                #     drive state.difference_setpoint_t4a in Goal.Range(0, 0.1)
            }
            ...
            lesson `learn 1` {
                scenario { 
                    ...
                    initial_setpoint_final_temperature: number <37 .. 38>
                }
            }
        }
    }
