...
from chuveiro_controle_h import MalhaFechada, ChuveiroTurbinado
...
class ChuveiroTurbinadoSimulation():
    ...
    def reset(
        ...
        print(self.custo_eletrico_kwh, self.custo_gas_kg)
    ...
    def episode_start(self, config) -> None:
        ...
        self.reset(
            ...
            T0 = config.get('variaveis_estado_iniciais') or [60,  35,  40,  35],
            SPh_0 = config.get('setpoint_inicial_nivel_tanque') or 60,
            potencia_eletrica_0 = config.get('potencia_eletrica_inicial') or 5.5,
            potencia_aquecedor_0 = config.get('potencia_aquecedor_inicial') or 29000,
            custo_eletrico_kwh_0 = config.get('custo_eletrico_kwh_inicial') or 1,
            custo_gas_kg_0 = config.get('custo_gas_kg_inicial') or 2,
            custo_agua_m3_0 = config.get('custo_agua_m3_inicial') or 3,
        )
    ...
    def step(self):
        ...
        # Simulação malha fechada com controlador PID no nível do tanque h: 
        malha_fechada = MalhaFechada(ChuveiroTurbinado, self.T0, self.TU,
                                     Kp_h = 1, Ti_h = 0.3, Td_h = 0.0, b_h = 1, 
                                     Ruido = 0.005, U_bias_h = 0.5, dt = self.dt)
...
def main_test():
    ...
    configs_banho = {
        ...
        'custo_eletrico_kwh': [1, 1.5, 2, 2.5, 3, 3.5], # reais/kwh
        'custo_gas_kg': [2, 2.5, 3], # reais/kg
        'custo_agua_m3': [3, 4, 5],
    }
    ...
    TU=[[20, 70, 100, 0.3, 60, 0.4672, 0, 25, 25],
        [30, 70, 100, 0.3, 60, 0.4672, 0, 25, 25],
        [40, 70, 100, 0.3, 60, 0.4672, 0, 25, 25],
        [50, 70, 100, 0.3, 70, 0.4672, 0, 25, 25],
        [60, 70, 100, 0.3, 70, 0.4672, 0, 25, 25],
        [70, 70, 100, 0.3, 70, 0.4672, 0, 25, 25],
        [80, 70, 100, 0.3, 70, 0.4672, 0, 25, 25],
        [90, 70, 100, 0.3, 70, 0.4672, 0, 25, 25],
        [100, 70, 100, 0.3, 40, 0.4672, 0, 25, 25],
